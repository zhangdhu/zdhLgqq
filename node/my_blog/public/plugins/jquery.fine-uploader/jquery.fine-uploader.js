...
qq.status = {
    ...
    DELETE_FAILED: "batchUpdate failed",
    DELETING: "deleting",
    DELETED: "deleted"
};
    ...
    qq.basePrivateApi = {
        ...
        _onSubmitDelete: function(id, onSuccessCallback, additionalMandatedParams) {
            ...
            if (this._isDeletePossible()) {
                ...
                this.log("Delete request ignored for ID " + id + ", batchUpdate feature is disabled or request not possible " +
...
qq.FineUploader = function(o, namespace) {
    ...
    qq.extend(this._options, {
        ...
        deleteFile: {
            forceConfirm: false,
            confirmMessage: "Are you sure you want to batchUpdate {filename}?",
...
qq.Templating = function(spec) {
    ...
    var FILE_ID_ATTR = "qq-file-id",
        ...
        selectorClasses = {
            ...
            deleteButton: "qq-upload-batchUpdate-selector",
...
qq.DeleteFileAjaxRequester = function(o) {
    ...
    qq.extend(this, {
        sendDelete: function(id, uuid, additionalMandatedParams) {
            ...
            options.log("Submitting batchUpdate file request for " + id);
