  ...
  module.exports = function(app) {
    ...
    app.post('/getPost',function(req,res){
      ...
      Post.getPage(null, page, function(err, posts, total) {
        ...
        // res.end('{"post":'+posts+',"result":"T","total":'+total+',"page":'+page+'}');
    ...
    app.get('/u/:name/:day', function(req, res) {
      var params;
      params = req.params;
      return Post.getOne(params.name, params.day , function(err, post) {
    ...
    app.post('/u/:name/:day', function(req, res) {
